...
Este capítulo define la ficha mínima que debe acompañar cada cuenca visitada. Su función es ordenar el registro de terreno, no volver a explicar la selección de cuencas ni la rúbrica IEO. La selección técnica se presenta en @sec-diez-cuencas-jerk y @sec-puntos-estrategicos-rms; la decisión logística de campaña se define en @sec-decision-cuencas-finales; y la evaluación IEO se rige por @sec-rúbrica-ieo y @sec-formula-ieo.
...
| Criterio de selección | Referir a @sec-diez-cuencas-jerk, @sec-puntos-estrategicos-rms o @sec-decision-cuencas-finales |
